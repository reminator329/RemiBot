...
public class RemiBot {
    ...
    public static void main(String[] arguments) throws Exception {
        token = arguments[0];
        JDA api = JDABuilder.create(token, GatewayIntent.GUILD_PRESENCES, GatewayIntent.GUILD_MEMBERS, GatewayIntent.GUILD_MESSAGES).enableCache(CacheFlag.ACTIVITY).build();
